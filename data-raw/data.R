...
empty_response_fg <- data.table::data.table(
  ...
  interpolation_id = character(0),
  display_cp = numeric(0),
  country_name = character(0),
  africa_split = character(0),
  africa_split_code = character(0),
  region_name = character(0),
  region_code = character(0),
  world = character(0),
  world_code = character(0),
  path = character(0),
  data_interpolation_id = character(0),
