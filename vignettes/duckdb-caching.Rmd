...
Since the table is empty, this call will do the calculation and save the result in the table for future use and return the output.
...
We are creating a duckdb file to save our table. The location of this file is saved in an environment variable `PIP_CACHE_FILE` (Example `Sys.setenv('PIP_CACHE_FILE' = fs::path('e:/PIP/pipapi_data/demo.duckdb'))`). A table called `master_file` is created inside it where we save our cache. 
...
# pip_DEV 593.396 628.3455 1355.73 647.4085 664.028 61786.03   100
...
#Unit: milliseconds
#           expr      min       lq    mean   median      uq      max neval
# duckdb_caching 97.96608 100.8852 115.458 103.0205 107.466 1135.287   100
```
