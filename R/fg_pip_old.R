...
fg_pip_old <- function(country,
  ...
  out <- fg_remove_duplicates_old(out)
...
#' OLD: Remove duplicated rows created during the interpolation process
#'
...
#' @return data.table
#'
fg_remove_duplicates_old <- function(df,
...
#' OLD: Standardize cache_id format to avoid duplication of rows
#'
...
#'
#' @return character
fg_standardize_cache_id_old <- function(cache_id,
                                    interpolation_id,
                                    reporting_level) {
...
#' OLD: Coerce variable causing potential duplicates to NAs
#'
#' @inheritParams fg_remove_duplicates_old
#'
#' @return data.table
fg_assign_nas_values_to_dup_cols_old <- function(df,
                                             cols) {
